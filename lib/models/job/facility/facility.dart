...
class Facility with _$Facility {
  factory Facility({
    ...
    @Default("") @JsonKey(name: 'fac_name') String facName,
    @Default("") @JsonKey(name: 'fac_street_address') String facStreetAddress,
    @Default("") @JsonKey(name: 'fac_city') String facCity,
    @Default("") @JsonKey(name: 'fac_zip_code') String facZipCode,
    @Default("")
    @JsonKey(name: 'fac_state_abbreviation')
        String facStateAbbreviation,
